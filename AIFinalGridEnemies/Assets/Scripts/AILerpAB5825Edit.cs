...
namespace Pathfinding {
	...
	[AddComponentMenu("Pathfinding/AI/AILerpAB5825Edit (2D,3D)")]
	[HelpURL("http://arongranberg.com/astar/docs/class_pathfinding_1_1_a_i_lerp.php")]
	public class AILerpAB5825Edit : VersionedMonoBehaviour, IAstarAI {
		/// <summary>
		...
		public void MovementUpdate (float deltaTime, out Vector3 nextPosition, out Quaternion nextRotation) {
			...
			//EDIT: replaced direction with new vector3 (dir x 0 dir z)
			if (enableRotation) nextRotation = SimulateRotationTowards(new Vector3(direction.x, 0f, direction.z), deltaTime);
